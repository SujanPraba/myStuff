...
export default function NavLeftToRight() {
 ...
 return (
   <nav className="flex items-center justify-between flex-wrap p-6 bg-primary">
     ...
     <div
       className={`w-full block flex-grow  lg:flex lg:items-center lg:w-auto transition-all duration-800 ${isOpen ? "block" : "hidden"}`}
     >
